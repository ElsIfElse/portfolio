    ...
    return ( 
        <div className="section">
            ...
            lg:w-[940px] lg:gap-0">
                ...
                className="w-[6px] blur-[1px] h-[6px] bg-green-600 rounded-full"></motion.div> : <div className="w-[6px] blur-[1px] h-[6px] bg-rgba(28,45,50,0) rounded-full"></div>}Game Development</motion.button>
