    ...
    [
        {
            ...
            description:"Incremental roguelite deck builder game on a space ship.",
            stack:["Unity","Cinemachine","State Machine","Save System"],
            link:`project/00`,        
        },
        {
            name:"Castle of Doom",
        ...
        },
        {
            ...
            description:"You play as an office IT worker in a data entry company. Interact with objects, find out the office secrets and balance work-life balance so your wife doesn't leave You.",
            stack:["Unity","C#","State Machine","Cinemachine","Global Lock System","Interaction System"],
            link:`project/03`,        
        },
        {
            name:"Soulslike System",
            image:"./soulslikeThumbnail.jpeg",
            description:"Root motion based soulslike combat and movement system with simple enemy AI implementation.",
            stack:["Unity","C#","State Machine","Cinemachine","Root Motion","Action Buffer"],
            link:`project/04`,        
        },
        {
        ...
        },
        {
            ...
            image:"./kingdomManager_02.png",
            description:"Decide your kingdom's fate and manage your kingdom's resources through events where the player has to make a choice that influences what resource is spent and what is obtained. ",
            stack:["Unity","C#","State Machines","Game Design","Object Pooling"],
            link:`project/07`,        
        },
        {
