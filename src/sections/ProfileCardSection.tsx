            ...
            <div className="flex flex-row items-center justify-start gap-3">
                ...
                <div className="flex flex-col">
                    ...
                    <div className="flex flex-row gap-1 translate-y-1">
                        <a href="https://elseifelse.itch.io/" className="profile-link flex flex-row justify-center items-center gap-1"><img className="w-[20px] h-[20px]" src="./itchIcon.svg"></img>Itch.io</a>
